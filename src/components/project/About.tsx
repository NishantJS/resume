...
const AboutSection: FC<AboutSectionProps> = ({ project }) => {
  return (
    <section className="relative pt-12 min-h-screen lg:overflow-hidden lg:max-h-screen">
      <div className="flex flex-wrap items-center lg:justify-center  mt-16 md:mt-0">
        ...
        <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[500px] w-[250px] lg:mt-0 mt-8 lg:ml-0 lg:self-center">
          ...
          <div className="rounded-[2rem] overflow-hidden w-[222px] h-[472px] bg-white dark:bg-gray-800">
            <img src={`/project/${project.title}/header.png`} className="w-[222px] h-[472px]" alt={`${project.title} header`} />
          </div>
        </div>
      </div>
    </section>
